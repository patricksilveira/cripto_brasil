    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 px-5 py-4 text-sm text-blue-900">
        ...
        <p>
          ...
          . Data analysis produced in April 2026. USD conversion uses monthly average rates from Bacen.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Official RFB Report · April 2026</p>
      </div>

      {/* Lead paragraph */}
      <p className="text-base leading-relaxed text-foreground">
        The Brazilian crypto market closed 2025 as a large, high-velocity, stablecoin-led ecosystem with
        <strong> R$ 505.5 billion</strong> in trailing 12-month reported volume and{" "}
        <strong>R$ 1.724 trillion</strong> in cumulative reported volume since the series began in 2019.
        The last 12 months alone account for <strong>29.3%</strong> of all historical volume in the dataset,
      ...
      <div className="rounded-xl border border-border bg-zinc-50 px-6 py-5">
        ...
        <p className="text-sm leading-relaxed">
          ...
          volume remained near record levels — suggesting the market kept the money flow while shedding much
          of the noisier participation base.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            Total historical reported volume reached <strong className="text-foreground">R$ 1.724 trillion</strong> by
            December 2025. The trailing 12-month period contributed R$ 505.5 billion (29.3% of all-time volume).
            Monthly activity remained elevated throughout 2025: October at R$ 50.96B, November at R$ 54.72B,
            December at R$ 43.10B.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed text-muted-foreground mb-4">
            Over the trailing 12 months, USDT represented <strong className="text-foreground">72.0%</strong> of all
            reported crypto volume in Brazil. Combined, USDT and USDC made up <strong className="text-foreground">79.2%</strong> of
          ...
          <div className="rounded-lg border border-border overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                {[
                  { asset: "USDT", share: "72.0%", highlight: true },
                  { asset: "USDC", share: "7.3%", highlight: true },
                  { asset: "BTC", share: "10.6%", highlight: false },
                  { asset: "ETH", share: "3.7%", highlight: false },
                  { asset: "SOL", share: "1.8%", highlight: false },
                ].map(r => (
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            Unique active CNPJs peaked at <strong className="text-foreground">421,416</strong> in February 2024
            and fell to <strong className="text-foreground">67,324</strong> by December 2025 — an{" "}
            <strong className="text-foreground">84% contraction</strong> from peak. Even with that collapse in
            entity count, transaction value did not collapse with it, implying that higher-volume professional
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            and ended December 2025 at <strong className="text-foreground">3.54 million</strong>. CNPJs ended at 67,324 —
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            The key story is not mass-user expansion in 2025, but <strong className="text-foreground">balance-sheet-scale
        ...
        <section className="rounded-xl border border-border bg-muted/30 px-6 py-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { label: "Total Historical Volume", value: "R$ 1.724 trillion" },
              { label: "Past 12 Months Volume", value: "R$ 505.5 billion (29.3% of all-time)" },
              { label: "Stablecoin Share (USDT + USDC)", value: "79.2%" },
              { label: "BTC / ETH / SOL", value: "10.6% / 3.7% / 1.8%" },
              { label: "Peak Active CNPJs", value: "421,416 (Feb 2024)" },
              { label: "Active CNPJs at Dec 2025", value: "67,324 (−84% from peak)" },
              { label: "Peak Active CPFs", value: "9.21 million (Nov 2023)" },
              { label: "Active CPFs at Dec 2025", value: "3.54 million" },
            ].map(m => (
